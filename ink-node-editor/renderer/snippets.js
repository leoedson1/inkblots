...
`,
      ...
      {"id": "story-inkblots-tour", "label": "The Lantern Archive", "kind": "story", "desc": "A playable Inkblots showcase: choices, gathers, variables, lists, conditions, stitches, tunnels, functions, tags, text variations, comment balloons, zones and sticky notes.", "text": "// THE LANTERN ARCHIVE — an Inkblots tour.\n// Explore every room, then choose how the archive ends.\nVAR sparks = 0\nVAR helped = false\nLIST relics = brass_key, star_map\nVAR inventory = ()\nCONST goal = 2\n-> entrance\n\n=== entrance ===\n// Knots become nodes; diverts become connections.\n/* Author notes appear in the balloon.\nKeep the welcome calm and inviting. */\n# location: archive\nYou arrive at an archive whose lantern has gone dark.\n* [Ask the keeper for help]\n    ~ helped = true\n    \"Bring back two sparks,\" she says.\n* [Explore on your own]\n    You trust your curiosity.\n- Both paths meet beneath a painted ceiling.\n-> hub\n\n=== hub ===\n// Sticky choices let you return to the hub.\n{Welcome to the archive.|The archive feels more familiar.|You know these halls now.}\nYou carry {sparks} sparks. {helped:The keeper waves.}\n+ {not workshop} [Visit the workshop] -> workshop\n+ {not observatory} [Climb to the observatory] -> observatory\n+ [Listen to the clock] -> clock ->\n    You return to the hall.\n    -> hub\n+ [Check your collection] -> collection\n+ {sparks >= goal} [Restore the lantern] -> finale\n+ [Leave the archive] -> departure\n\n=== workshop ===\n// A function computes a value; a list tracks named items.\n~ sparks = add_spark(sparks)\n~ inventory += brass_key\nYou find a brass key in a bowl of light.\n-> hub\n\n=== observatory ===\n~ sparks = add_spark(sparks)\n~ inventory += star_map\n{shuffle:\n- A comet scratches the glass.\n- A silver moon fills the dome.\n- Stars gather like falling snow.\n}\nYou copy the sky onto a map.\n-> hub\n\n=== clock ===\n// A tunnel returns to its caller with ->->.\nThe clock strikes {&one|two|three}.\n->->\n\n=== collection ===\n-> inventory_view\n= inventory_view\n// A stitch divides a knot into smaller sections.\nYou have {LIST_COUNT(inventory)} relics.\n{inventory ? brass_key: A brass key.}\n{inventory ? star_map: A map of the stars.}\n{LIST_COUNT(inventory) == 0: Your pockets are empty.}\n+ [Return to the hall] -> hub\n\n=== finale ===\n// Conditional text and a final branching choice.\n{helped:\nThe keeper helps you raise the lantern.\n- else:\nYou raise the lantern alone.\n}\n* [Light it for everyone]\n    # ending: shared\n    Every window in the city shines.\n* [Keep a little light]\n    # ending: personal\n    A small star warms your pocket.\n- The archive opens its doors.\n-> END\n\n=== departure ===\n# ending: departure\nYou leave with {sparks} sparks and a story still unfinished.\n-> END\n\n=== function add_spark(current) ===\n~ return current + 1\n\n// --- Inkblots layout (safe to delete) ---\n// @layout {\"::start\": [-350, 90], \"entrance\": [70, 90], \"hub\": [440, 90], \"workshop\": [830, 30], \"observatory\": [830, 360], \"clock\": [440, 490], \"collection\": [1200, 30], \"collection.inventory_view\": [1200, 220], \"finale\": [1580, 30], \"departure\": [1580, 530], \"add_spark\": [830, 730]}\n// @inkblots {\"zones\": [{\"id\": \"tour-welcome\", \"name\": \"Welcome & exploration\", \"members\": [\"entrance\", \"hub\", \"clock\"], \"x\": 40, \"y\": 20, \"w\": 730, \"h\": 750, \"color\": \"blue\"}, {\"id\": \"tour-relics\", \"name\": \"Relics & functions\", \"members\": [\"workshop\", \"observatory\", \"add_spark\"], \"x\": 800, \"y\": -40, \"w\": 360, \"h\": 1050, \"color\": \"green\"}, {\"id\": \"tour-endings\", \"name\": \"Endings\", \"members\": [\"finale\", \"departure\"], \"x\": 1550, \"y\": -40, \"w\": 360, \"h\": 930, \"color\": \"rose\"}], \"notes\": [{\"id\": \"tour-note\", \"x\": -350, \"y\": 400, \"w\": 300, \"h\": 280, \"text\": \"START HERE\\nPlay from Start to explore the archive. Visit both rooms, inspect your collection, then restore the lantern.\\n\\nShift-drag to select nodes; Ctrl+G to group. Hover the comment balloons. Help \\u2192 Inkblots user guide explains the editor.\", \"color\": \"amber\"}]}\n"},
      {
